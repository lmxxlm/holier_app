        ...
        <style>
           ...
           .main .all{
            ...
            #container .mask .picNum{
                ...
                margin-left:13px;
                padding-left:30px;
                background:url(../assets/image/eg/phone.png) no-repeat 0 50%;
            }
            
            #container .mask .bed{float:right;margin-right:13px;}
            ...
            .info p.address{
               background:url(../assets/image/eg/address.jpg) no-repeat 0 50%;
            }
            .info p.hosInfo{
              position:relative;
               background:url(../assets/image/eg/hosInfo.jpg) no-repeat 0 50%;
            }
