     ...
     <body>
        ...
        <div class="til">
            ...
            <div class="writeInfo">
               ...
               <hr>
               <p><span>备注说明</span></p>
                <textarea name="describe" placeholder="在这里您可以输入对康复的诉求，期望，对自己病情的描述"/></textarea><br>
               <hr> 
            </div>
    	...
    	$.post(questURL,questArr,function(result){
    		if(result){
    			...
    			window.location.href="turn_hospital.html";
    		}else{
    			alert("系统开小差了，请稍后重试。");
    			return false;
    		}
