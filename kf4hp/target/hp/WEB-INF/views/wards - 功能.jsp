...
.addBtn{background: #044599 none no-repeat scroll 0 0;
padding: 5px 10px;
color: #fff;
border: none;
border-radius: 5px;
...
<body>
    <div id="frameMain">
        <div id="top_nav">当前位置：病房管理<button class="addBtn"  name="addBtn">添加</button></div>
        ...
        <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
            ...
            <c:forEach items="${bedRoomList}" var="record">
                 ...
                 -->
                    ...
                    <td>
                       <a href="wardInfo.html?roomId=${record.record_id}" class="detail">查看详情</a>
                       <a href="wardInfoEdit.html?roomId=${record.record_id}" class="edit">修改</a>
                       <a href="javascript:void(0)" data-id="${record.record_id}" class="delete">删除</a>
                    </td>
                </tr>
            </c:forEach>
...
$(function(){
    ...
    $('input[name="IDCheck"]').live('click',function(){
	 ...
	 $('button[name="addBtn"]').on('click',function(){
		 window.location.href="wardInfoAdd.html";
	 });
	 ...
	 $('.delete').on('click',function(){
		 ...
		 var questURL=runParams.mainUrl+'delete_room.do';
		 var questArr={
				 id:id,
				 token:token
		 };
