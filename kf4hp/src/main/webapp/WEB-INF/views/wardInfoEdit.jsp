...
#table2  .editTd input[name="edit"]{ margin-left:50%;padding:10px;color:#777 !important;border-radius:10px;}
#table2  .editTd input[name="edit"]:hover{color:#333 !important;}
        ...
        <!-- ---- -->
         <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0" id="table2">
                ...
                <tr>
                    ...
                    <td class="td1 editTd" ><input type="button" name="edit" value="确定修改" style="text-align:center;"></input></td>
                </tr>
        </table>
...
$(function(){
	...
	$('input[name="edit"]').on('click',function(){
		var bedroom_name=$('#table2 input[name="bedroom_name"]').val();
		var price=$('#table2 input[name="price"]').val();
		var space=$('#table2 input[name="space"]').val();
		var bednumber=$('#table2 input[name="bednumber"]').val();
		var floor=$('#table2 input[name="floor"]').val();
		var tags=$('#table2 input[name="tags"]').val();
		var token=$('input[name="token"]').val();
