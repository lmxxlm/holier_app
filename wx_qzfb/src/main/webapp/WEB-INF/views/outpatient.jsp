...
<div class="headWrap">
    ...
    <div class="head">
        ...
        <a href="#" style="text-decoration:none;">${DepartmentName}</a><span data-count="${count}"
                                                                             class="data-count">(${count})名</span>
    </div>
</div>
<div class="content" style="margin-top:111px;">
            ...
            <section>
                <div class="doc_info" style="position:relative;">
                    ...
                    <div class="info">
                        ...
                        <p class="p1 introP" style="color:#333; margin:0.8em 0;"><span
                                class="span1 doctorName">${record.doctorName}</span></p>
                        ...
                        <p class="p2" style="margin:0.8em 0;"><span class="sw"></span><span>${record.sessionName}</span>&nbsp;&nbsp;<span>${record.startTime}&nbsp;-&nbsp;${record.endTime}</span>
                        </p>
                    </div>
                </div>
    ...
    <a href="javascript:void(0)" class="gotoOrder" style="text-decoration:none;color:#555;">
        <section>
            <div class="doc_info" style="position:relative;">
                <img src="assets/image/productAdmin/doc/医生头像.png" style="top:0.7em;" class="headImg"/>
                <div class="info">
                    <input type="hidden" name="scheduleItemCode" value="${record.scheduleItemCode}">
                    <input type="hidden" name="doctorName" value="${record.doctorName}">
                    <p class="p1 introP" style="color:#333; margin:0.8em 0;"><span
                            class="span1 doctorName">张小明</span></p>
                    <p class="p2" style="margin:0.8em 0;"><span class="span2">主任医师</span></p>
                    <!-- 	                     <p class="p2"><span class="span1">线上接诊</span><a>&nbsp;0</a>&nbsp;|&nbsp;&nbsp;<span class="span2">评价-</span></p> -->
                    <p class="p2" style="margin:0.8em 0;"><span class="sw"></span><span>心内科</span>&nbsp;&nbsp;<span>9:00&nbsp;-&nbsp;12:00</span>
                    </p>
                </div>
            </div>
        </section>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        function noList() {
            ...
            if (count == '0' || !count) {
                $('.head').find('span[class="data-count"]').css("color", "#999999").html("预约号已满。");
            }
        }
        ...
        var showTime = function () {
            ...
            if (activeTime != tdStr) {
                ...
                $(".swiper-wrapper .swiper-slide").eq(0).children('a').css({
                    'background': '#eee',
                    'color': '#41b2a6',
                    'border-bottom': '2px solid #41b2a6'
                });
                $(".swiper-wrapper .swiper-slide").eq(0).children('a').addClass('active');
            }
        };
        showTime();
