...
.swiper-container{border-bottom:1px solid #ccc;height:3.9em;}
.swiper-slide:hover{background:none;}
.swiper-slide a{padding:0.5em 1em;text-decoration:none;display:inline-block;color:#999;text-align:center;}
             ...
             <a href="javascript:void(0)" class="gotoOrder" style="text-decoration:none;color:#999999;">
                <section>
	               <div class="doc_info" style="position:relative;">
	                  <img src="assets/image/productAdmin/outpatient/doc.png" style="top:0.7em;"/>
	                  <div class="info">
	                     <input type="hidden" name="scheduleItemCode" value="${record.scheduleItemCode}">
	                     <p class="p1 introP" style="color:#333; margin:0.8em 0;"> <span class="span1">${record.doctorName}</span></p>
