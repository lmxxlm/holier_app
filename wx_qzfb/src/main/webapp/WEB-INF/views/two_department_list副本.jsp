...
.submit{border-radius:0.5em;}
		...
		/*关闭*/
		#modal img{width:1.8em;position:absolute;top:0.8em;right:1em;color:#fff;}
</style>
</head>
<body>
...
<c:forEach items="${secondDepartmentList}" var="sd">
	<section class="halfPxBorderBottom">
	    ...
	    <div class="depInfo">${sd.departmentIntro}<span class="detail" style="color:red;font-size:0.9em;">查看更多</span></div>
