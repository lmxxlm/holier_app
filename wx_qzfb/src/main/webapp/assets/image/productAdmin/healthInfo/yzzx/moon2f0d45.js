...
},a.moon_lid=D,E[D]=o,D++,e.call(i,t,o,n);
};
}
function c(e){
return function(t,o,n){
...
var l,u,d,f,w,m,p,_=/MicroMessenger/i.test(navigator.userAgent),h=window.define,v=0,g=2,y=4,O=9,j=10;
if(window.__initCatch=function(e){
l=e.idkey,u=e.startKey||0,d=e.limit,f=e.badjsId,w=e.reportOpt||"",m=e.extInfo||"";
...
var v=1/0==d?u:u+h.offset;
a[p]="[moon]"+l+"_"+v+";"+h.log+";"+n(h.e||{})||"",s[p]=v,c[p]=1;
}
}
for(var g=0;g<s.length;g++)w[g]=l+"_"+s[g]+"_"+c[g],r=r+"&log"+g+"="+a[g];
if(w.length>0&&(i("POST",location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?","idkey="+w.join(";")+"&lc="+a.length+r),
f)){
var O=new Image,j="https://badjs.weixinbridge.com/badjs?id="+f+"&level=4&from="+encodeURIComponent(location.host)+"&msg="+encodeURIComponent(r);
...
var i=e.localStorage,a=document.head||document.getElementsByTagName("head")[0],s=1,c=1,l={
prefix:"__MOON__",
loaded:[],
unload:[],
hit_num:0,
...
load:function(e){
if(!e||e.length<=0)return seajs.combo_status=seajs.COMBO_LOADED,seajs.run(),void console.info("[moon] load js complete, all in cache, cost time : 0ms, total count : "+l.mod_num+", hit num: "+l.hit_num);
...
if(t++,t==e.length){
var n=+new Date-o;
seajs.combo_status=seajs.COMBO_LOADED,seajs.run(),console.info("[moon] load js complete, url num : "+e.length+", total mod count : "+l.mod_num+", hit num: "+l.hit_num+", use time : "+n+"ms");
}
});
});
},
