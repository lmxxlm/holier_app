$(function(){
	...
	function initMenu(){
		var menuIndex = $("input[name='menuIndex']").val();
        	switch(menuIndex){
        	case "hospital_manage":
		    	$('.menulist').children('.hos_gl').addClass('active');
		    	break;
        	case "departments_manage":
		    	$('.menulist').children('.ks_gl').addClass('active');
		    	break;
        	case "illness_area_manage":
		    	$('.menulist').children('.bq_gl').addClass('active');
		    	break;
        	case "device_category_manage":
		    	$('.menulist').children('.sblb_gl').addClass('active');
		    	break;
        	case "device_manage":
		    	$('.menulist').children('.sb_cpyd').addClass('active');
		    	break;
        	case "doc_manage":
		    	$('.menulist').children('.doc_gl').addClass('active');
		    	break;
        	case "allOrder":
		    	$('.menulist').children('.allOrder').addClass('active');
		    	break;
        	}
	}
